...
new #[Title('Movie — Quiz App')] class extends Component {
    ...
    {
        $questionIds = $this->movie->questions()->active()->inRandomOrder()->limit($this->questionCount)->pluck('id')->toArray();
    ...
    <div class="mx-auto max-w-lg">
        <div class="mb-6">
            <a href="{{ route('movies') }}" wire:navigate
                class="text-sm font-medium text-ocean-500 hover:text-ocean-600 transition-colors">&larr; Back to
                Movies</a>
        </div>
        ...
        <div class="rounded-2xl bg-white/80 backdrop-blur-sm border-2 border-white p-6 animate-fade-in-up">
            ...
            @if ($availableQuestions > 0)
                <div class="mt-6 border-t border-gray-100 pt-6">
                    ...
                    <select id="question-count" wire:model="questionCount"
                    ...
                    <button wire:click="startQuiz" x-data="{ pressed: false }"
